...
public class CustomerUI : MonoBehaviour
{
    ...
    {
        recipePanelScaleAnimation.ScaleInAnimation(recipePanel);
        recipeHeaderImageScaleAnimation.ScaleInAnimation(recipeHeaderImage);
    ...
    {
        recipePanelScaleAnimation.ScaleOutAnimation(recipePanel);
        recipeHeaderImageScaleAnimation.ScaleOutAnimation(recipeHeaderImage);
